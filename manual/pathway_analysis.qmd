...
#### Data upload
User can upload the direct output result from the main analysis. At present, user can upload the DMC data produced by the main analysis (See @sec-transcript). The input file should be in a **text (tab-delimited)** format.
