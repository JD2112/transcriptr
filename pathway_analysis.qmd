...
![Input files and view](images/pathway/path1.png){#fig-path1}
...
![Figure parameters](images/pathway/path1-1.png){#fig-path11}
...
![Analysis Result-interactivity](images/pathway/path1-2.png){#fig-path12}
...
![Pathway map](images/pathway/path3.png){#fig-path3}
...
![Gene details](images/pathway/path4.png){#fig-path4}
