...
![Docker container: Figure 1](images/docker_container_windows1.png)
...
2. If after uploading the data for methylation analysis (see @sec-transcript), the browser get disconnected, please check you have installed the docker or docker-desktop with administrative privilages. From terminal, user can run,
```
