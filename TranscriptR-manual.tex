...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colframe=quarto-callout-important-color-frame, coltitle=black, leftrule=.75mm, bottomrule=.15mm, bottomtitle=1mm, colback=white, opacitybacktitle=0.6, arc=.35mm, left=2mm, opacityback=0, breakable, toptitle=1mm, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colframe=quarto-callout-warning-color-frame, coltitle=black, leftrule=.75mm, bottomrule=.15mm, bottomtitle=1mm, colback=white, opacitybacktitle=0.6, arc=.35mm, left=2mm, opacityback=0, breakable, toptitle=1mm, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Danger}, colframe=quarto-callout-caution-color-frame, coltitle=black, leftrule=.75mm, bottomrule=.15mm, bottomtitle=1mm, colback=white, opacitybacktitle=0.6, arc=.35mm, left=2mm, opacityback=0, breakable, toptitle=1mm, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, toprule=.15mm]
